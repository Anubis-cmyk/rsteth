...
class DeleteConfirmPopupOneScreen extends StatelessWidget {
  const DeleteConfirmPopupOneScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Container(
                      width: 241.h,
                      margin:
                          EdgeInsets.only(left: 31.h, top: 6.v, right: 30.h),
                      child: Text("msg_do_you_really_want2".tr,
                          maxLines: 2,
  ...
  onTapRowcancel(BuildContext context) {
