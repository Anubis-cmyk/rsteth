...
class RecordingStartedNumberOneScreen extends StatelessWidget {
  RecordingStartedNumberOneScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: Container(
                              ...
                              margin: EdgeInsets.only(
                                  left: 45.h, top: 4.v, right: 44.h),
                              child: RichText(
                                  text: TextSpan(children: [
                                    TextSpan(
                                        text: "msg_hold_the_device2".tr,
                                        style: CustomTextStyles
                                            .titleSmallInterPrimary),
                                    TextSpan(
                                        text: "msg_number_1_area_for".tr,
                                        style: CustomTextStyles
                      ...
                      Padding(
                          padding: EdgeInsets.fromLTRB(22.h, 23.v, 54.h, 8.v),
                          child: Row(children: [
                            Padding(
                                padding:
                                    EdgeInsets.only(top: 26.v, bottom: 24.v),
                                child: Text("lbl_00_00_05".tr,
                                    style: CustomTextStyles
