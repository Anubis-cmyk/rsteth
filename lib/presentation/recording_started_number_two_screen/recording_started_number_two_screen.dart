...
class RecordingStartedNumberTwoScreen extends StatelessWidget {
  RecordingStartedNumberTwoScreen({Key? key}) : super(key: key);
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          padding: EdgeInsets.fromLTRB(24.h, 23.v, 54.h, 6.v),
                          child: Row(children: [
                            Padding(
                                padding:
                                    EdgeInsets.only(top: 26.v, bottom: 24.v),
                                child: Text("lbl_00_00_15".tr,
                                    style: CustomTextStyles
